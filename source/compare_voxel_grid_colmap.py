...
# Extract parent folder and name of colmap voxel_grids
parent_folder_colmap, filename_colmap = extract_folder_and_filename(path_to_colmap_voxel_grid)
if debug:
    print("Extracting colmap voxel grid path:")
    print("Parent folder colmap:", parent_folder_colmap)
    print("Filename colmap:", filename_colmap)

# Get the parent folder of parent_folder_gt
project_folder = os.path.dirname(parent_folder_colmap)
...
id_current_object = filename_colmap.split('_')[0]
...
path_colmap_scatterplot =  create_png_path(file_path_metrics, filename_colmap)
path_colmap_color_points = create_png_path_2(file_path_metrics, filename_colmap)
#===================================================================================
#===================================================================================
#===================================================================================
...
print("TEST_1: VOXEL MATCHING COLMAP -> GROUND TRUTH (based on center w boundaries)")
print("COLMAP")
...
content = """
# START COLMAP MATCH
# COLMAP Voxels at ground truth: {}
# COLMAP Voxels at estimate: {}
# COLMAP Voxels matched at colmap: {}
# COLMAP %Voxels matched at colmap: {:.2f}%
# COLMAP Recall = TP/(TP+FN): {:.2f}
# END COLMAP MATCH
""".format(len(coords_gt), len(voxels_colmap), len(coords_colmap_found_w_bound), (len(coords_colmap_found_w_bound)/len(voxels_colmap))*100, len(coords_colmap_found_w_bound)/(len(coords_colmap_found_w_bound) + (len(coords_gt) - len(coords_colmap_found_w_bound))))
...
## TEST_2 VOXEL DISTANCE COLMAP -> GROUND TRUTH  (based on center with boundaries)
## COLMAP
# Find nearest voxel at ground truth voxel grid for all estimated voxels (based on center with boundaries)
#===================================================================================
#===================================================================================
#===================================================================================
print("\n")
...
print("TEST_2 VOXEL DISTANCE COLMAP -> GROUND TRUTH  (based on center with boundaries)")
print("COLMAP")
print("Find nearest voxel at ground truth voxel grid for all estimated voxels (based on center with boundaries)\n")
...
plt.savefig(path_colmap_scatterplot)
plt.close()  
...
plt.savefig(path_colmap_color_points)
plt.close()
...
# Define the content to write to the file
content = """
# START COLMAP DISTANCES
# COLMAP Minimum Distance: {:.2f}
# COLMAP Maximum Distance: {:.2f}
# COLMAP Distances Mean Absolute Error (MAE): {:.2f}
# COLMAP Distances Root Mean Square Error (RMSE): {:.2f}
# COLMAP Distances Mean Squared Error (MSE): {:.2f}
# END COLMAP DISTANCES
""".format(minimum_distance_colmap_w_bound, maximum_distance_colmap_w_bound, mae_colmap_w_bound, rmse_colmap_w_bound, mse_colmap_w_bound)
